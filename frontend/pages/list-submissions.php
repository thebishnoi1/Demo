...
<h2>
	List of submissions
	<a href="<?php echo $main.'?page=add-edit-book';?>" class="button button-primary" style="margin-top:-5px; margin-left: 15px;">
		Add New
	</a>
</h2>
...
foreach($submissions as $row){ ?>
	<tr>
		...
		<td>
			<button class="button button-primary" onclick="window.location.href='<?php echo $main.'?page=submit-book&id='.$row->id;?>'">Submit book</button>
			&nbsp;
			<button class="button button-primary" onclick="window.location.href='<?php echo $main.'?page=add-edit-book&book-id='. $row->id ; ?>'">Edit book</button>
			&nbsp;
